...
public class dining_philosopher {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("You would like to a book a table for ?");
		number = sc.nextInt();
		...
		final Fork f[] = new Fork[number];
		final Philosopher p[] = new Philosopher[number];
...
class Philosopher {
	...
	public void eat() throws InterruptedException {
		...
		if(!rightPick){
			left.free();
			System.out.println("Cannot pick up right fork so leaving ....huh...");
			return;
		}
